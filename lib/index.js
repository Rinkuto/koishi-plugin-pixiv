    ...
    ctx.command('来张色图 [tag:text]', '随机一张色图')
        ...
        try {
            ...
            if (image.urls === undefined) {
                await session.send((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("at", { id: session.userId }), (0, jsx_runtime_1.jsx)("text", { content: '没有获取到喵\n' })] }));
            }
            else {
                session.send((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("at", { id: session.userId }), (0, jsx_runtime_1.jsx)("image", { url: image.urls.original }), (0, jsx_runtime_1.jsx)("text", { content: `title：${image.title}\n` }), (0, jsx_runtime_1.jsx)("text", { content: `id：${image.pid}\n` }), (0, jsx_runtime_1.jsx)("text", { content: `tags：${image.tags.map((item) => {
                    ...
                    if (res.length === 0) {
                        ...
                        session.send((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("at", { id: session.userId }), (0, jsx_runtime_1.jsx)("text", { content: '图片发送失败了喵\n' }), (0, jsx_runtime_1.jsx)("text", { content: image.urls.original })] }));
                    }
                });
            }
        }
            ...
            logger.error(e);
            await session.send((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("at", { id: session.userId }), (0, jsx_runtime_1.jsx)("text", { content: '图片发送失败了喵\n' })] }));
        }
    });
}
exports.apply = apply;
